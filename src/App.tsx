...
export function App() {
  return (
    <div className="relative min-h-dvh">
      {/* background: fixed so it still covers the viewport when content scrolls */}
      ...
      <div className="pointer-events-none relative flex min-h-dvh w-full justify-center bg-background/5 backdrop-blur-lg">
        <div className="flex min-h-dvh w-full max-w-[1350px] flex-col">
          ...
          <div className="flex h-12 shrink-0 items-center justify-between px-4 sm:px-6">
            <h1 className="font-quantico text-xl font-semibold text-black sm:text-2xl">
            korospace
            </h1>
          ...
          {/* body */}
          <div className="flex flex-1 flex-col items-center gap-10 px-5 py-10 sm:px-8 lg:flex-row lg:gap-6 lg:py-0">
            {/* left: copy */}
            <div className="flex w-full flex-col items-center justify-center lg:flex-1">
              <div className="flex w-full max-w-xl flex-col items-center lg:items-start">
                <h1 className="text-center font-khand text-4xl leading-tight font-semibold text-balance text-black sm:text-5xl lg:text-left xl:text-6xl">
                  Your{" "}
            ...
            <div className="pointer-events-auto flex w-full flex-col items-center justify-center lg:flex-1">
              ...
              <div className="mt-4 grid w-full max-w-2xl grid-cols-2 gap-x-4 gap-y-3 font-mono text-xs text-black sm:text-sm lg:flex lg:w-auto lg:divide-x-2 lg:divide-[#7ccf00]">
          ...
          <div className="pointer-events-auto shrink-0 px-5 py-2 text-center font-mono text-xs text-black sm:px-8 sm:text-sm lg:text-right">
            By{" "}
            <a
