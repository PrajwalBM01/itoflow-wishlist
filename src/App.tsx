      ...
      <div className="pointer-events-none relative flex min-h-dvh w-full justify-center bg-background/5 backdrop-blur-lg">
        <div className="flex min-h-dvh w-full max-w-[1350px] flex-col">
          ...
          <div className="flex h-12 shrink-0 items-center justify-between px-4 sm:px-6">
            <h1 className="font-quantico text-xl font-semibold  sm:text-2xl">
            korospace
            </h1>
            <span className="flex items-center gap-2 rounded-lg bg-white/15 p-1 px-2 text-xs  shadow sm:text-sm">
              Coming soon
          ...
          <div className="pointer-events-auto shrink-0 px-5 py-2 text-center font-mono text-xs  sm:px-8 sm:text-sm lg:text-right">
            By{" "}
            <a
